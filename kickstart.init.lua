...
--  yap will yank an entire paragragph
...
require("lazy").setup({
	...
	-- go through 'which key' and se if it works in my workflow
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- 'ctrl' + '^' --- does a switch to an alternate file -- prime loves this one
